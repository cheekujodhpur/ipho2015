...
function html(files, dir, useIcons, view) {
  return '<table class="table table-bordered" id="files" class="view-' + view + '">'
    + (view == 'details' ? (
      '<thead>'
      + '<tr>'
      + '<th><span class="name" style="align:right"> Name </span></th>'
      + '<th><span class="size style="align:right""> Size </span></th>'
      + '<th><span class="date" style="align:right"> Modified </span></th>'
      + '</tr>'
      + '</thead>') : '')
      + '<tbody>'
  ...
  var isDir = '..' == file.name || (file.stat && file.stat.isDirectory())
    ...
    return '<tr><td><a href="'
      ...
      + classes.join(' ') + '"'
      + ' title="' + file.name + '">'
      + '<span class="name">'+file.name+'</span></td></a>'
