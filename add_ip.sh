...
echo $inp
mongo test --eval $inp
inp='db.uploads.insert({"ip":"'$1'","country_name":"'$2'","country_code":"'$3'","T1":false,"T2":false,"T3":false,"E":false,"T1_alert":false,"T2_alert":false,"T3_alert":false,"E_alert":false,"T1_printed":false,"T2_printed":false,"T3_printed":false,"E_printed":false,"T1_packed":false,"T2_packed":false,"T3_packed":false,"E_packed":false,})'
echo $inp
mongo test --eval $inp
